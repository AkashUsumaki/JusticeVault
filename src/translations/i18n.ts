...
export const translations: Record<LanguageCode, TranslationDictionary> = {
  ...
  hi: {
    appName: "JusticeVault",
    appSubtitle: "Government of India • Ministry of Home Affairs • Digital Evidence & Investigation Portal",
    badgeId: "Badge ID",
    policeStation: "Police Station",
    ...
    navDashboard: "Command Center",
    navCases: "First Information Reports (FIR)",
    navEvidence: "Evidence Vault (Database)",
    navVictimEnquiry: "Victim Voice Statement",
    navMapLocations: "OpenStreetMap Radar",
    navAIVerifier: "AI Statement Verifier",
    navRelations: "Incident Link Graph",
    navBlockchain: "Blockchain & Chain of Custody",
    navSharing: "Inter-Station Evidence Sharing",
    navIntegrations: "Police Systems (CCTNS)",
    navMobileField: "Field Capture (Mobile)",
    
    loginTitle: "Law Enforcement Portal Access",
    loginSubtitle: "State Police Biometric & 2FA Required",
    kycFaceAuth: "Police Biometric Face Authentication",
    faceLivenessCheck: "Active Face Liveness Check",
    faceVerified: "Face & Liveness Verified",
    faceScanning: "Aligning facial geometry...",
    mfaOtp: "Mobile OTP Verification",
    sendOtp: "Send OTP to Registered Device",
    verifyAndLogin: "Verify & Enter Portal",
    supervisorApproved: "Supervisor Approved (KMS Encrypted)",
    
    caseDashboard: "Case Investigation Workspace",
    newFIR: "Register New FIR",
    firNumber: "FIR Number",
    caseId: "System Case ID",
    offenceSections: ["BNS / IPC Offence Sections"],
    statusOpen: "Open",
    ...
    statusChargesheet: "Charge Sheet Filed",
    statusClosed: "Disposed / Closed",
    deadlineAlert: "Statutory 90-Day Chargesheet Deadline Tracker",
    daysRemaining: "Days Remaining",
    evidenceCount: "Evidence Items",
    complainant: "Complainant Details",
    accused: "Accused / Suspects",
    incidentDesc: "Incident Summary",
    
    evidenceVault: "Secure Digital Evidence Vault",
    uploadEvidence: "Upload Digital Evidence",
    dragDropText: "Drag & drop files (Max 100MB)",
    sha256Verification: "Cryptographic SHA-256 Hash",
    malwareClean: "ClamAV / VirusTotal Anti-Malware: CLEAN",
    encryptedAES: "AES-256 Envelope Encrypted",
    signedUrlNotice: "Time-limited signed token",
    verifyIntegrity: "Verify Cryptographic Integrity",
    tamperTest: "Simulate Tamper Alert",
    tamperDetectedAlert: "WARNING: SHA-256 hash mismatch! Access blocked & incident logged to blockchain.",
    versionHistory: "Immutable Version History",
    
    aiStatementAnalysis: "AI Cross-Evidence Statement Verifier",
    aiSubtitle: "Automatic claim extraction and cross-referencing against CDR, CCTV & physical evidence",
    inputStatement: "Enter Witness / Suspect Statement",
    recordAudio: "Record Audio Statement",
    analyzeClaims: "Verify Claims Against Evidence",
    consistent: "Consistent",
    contradicted: "Contradicted",
    unverified: "Unverified",
    requiresReview: "Review Required",
    confidenceScore: "AI Confidence Score",
    citedSources: "Cited Evidence Sources",
    aiDisclaimer: "Statutory Notice: AI does not determine guilt. It assists investigating officers under BSA 2023.",
    
    blockchainTitle: "Hyperledger Fabric Blockchain Ledger",
    hyperledgerInfo: "Law Enforcement Consortium Network",
    blockExplorer: "Block Explorer & Transactions",
    immutableLedger: "Immutable Signed Audit Ledger",
    generate65BCertificate: "Section 63 / 65B Electronic Evidence Certificate (PDF)",
    verifyChainOfCustody: "Verify Full Chain of Custody",
    txHash: "Transaction Hash (Tx Hash)",
    
    manualShareTitle: "Inter-Station Officer Sharing",
    selectStation: "Select Target Police Station",
    selectOfficer: "Select Recipient Officer",
    shareDuration: "Access Validity Period",
    viewOnly: "View Only",
    downloadAllowed: "Download Allowed",
    revokeShare: "Revoke Access Immediately",
    
    fieldCaptureTitle: "Field Officer Mobile Evidence Capture",
    gpsWatermark: "GPS & Timestamp Watermark",
    audioConsentGranted: "Statement Consent Recorded",
    qrEvidenceTag: "QR Seizure Tagging",
    offlineQueue: "Offline Evidence Queue",
    syncNow: "Sync to Central Vault",
    
    cctnsTitle: "CCTNS Crime & Criminal Tracking Network",
    eSakshyaTitle: "eSakshya Digital Evidence (SID Packet)",
    cyber1930Title: "1930 National Cybercrime Portal"
  }
};
